...
const Footer = () => {
  return (
    <div className="px-10 py-20 border-t border-solid border-slate-900 border-opacity-10 max-md:px-5">
        ...
        <div className="flex flex-col w-[32%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col text-sm font-light leading-5 text-slate-500 max-md:mt-10">
            <div className="flex gap-2 text-base font-bold leading-6 whitespace-nowrap text-zinc-700">
              ...
              />
              <div className="flex-auto">Aceternity</div>
            </div>
        ...
        <div className="flex flex-col ml-5 w-[68%] max-md:ml-0 max-md:w-full">
          <div className="flex gap-5 justify-between items-start mt-1.5 text-sm leading-5 text-neutral-600 max-md:flex-wrap max-md:mt-10">
            ...
            <div className="flex flex-col flex-1">
              ...
              <div className="mt-4 whitespace-nowrap">Terms and Conditions</div>
            ...
            <div className="flex flex-col flex-1">
              ...
              <div className="mt-4 whitespace-nowrap">Tailwindcss Buttons</div>
              <div className="mt-4 whitespace-nowrap">Mechanical Keyboard</div>
