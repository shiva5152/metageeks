...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "row-span-1   rounded-xl  hover:shadow-xl transition duration-200 shadow-input  p-4  border-gray-200 bg-white border hover:border-transparent justify-between flex flex-col space-y-4",
        className
      )}
    >
      {header}
